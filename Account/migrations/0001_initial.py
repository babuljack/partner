# Generated by Django 4.0.4 on 2022-04-11 20:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(null=True, upload_to=Account.models.img_path)),
                ('address', models.CharField(max_length=140, null=True)),
                ('quotes', models.CharField(blank=True, max_length=120, null=True)),
                ('website', models.CharField(blank=True, max_length=120, null=True)),
                ('twitter', models.CharField(blank=True, max_length=120, null=True)),
                ('instragram', models.CharField(blank=True, max_length=120, null=True)),
                ('facebook', models.CharField(blank=True, max_length=120, null=True)),
                ('github', models.CharField(blank=True, max_length=120, null=True)),
